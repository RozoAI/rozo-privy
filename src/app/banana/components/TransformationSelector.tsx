  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-400">
          {hasPreviousResult ? 'Transform Your Image Further' : 'Choose Your Transformation'}
        </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 max-w-7xl mx-auto">
        {transformations.map((transformation, index) => (
          <div
            ...
            className="group relative bg-gray-950/60 backdrop-blur-lg rounded-xl border border-white/10 hover:border-orange-500/50 hover:shadow-lg hover:shadow-orange-500/10 cursor-pointer transition-all duration-300 transform hover:-translate-y-1 overflow-hidden"
          >
            {/* Image preview */}
            {transformation.image ? (
              ...
              <div className="flex flex-col items-center justify-center p-6 md:p-8 aspect-[3/4] bg-gradient-to-br from-gray-900/50 to-gray-800/50">
