...
import { GoogleMap } from "@/components/lifestyle/google-map";
...
export default function LifestylePage() {
  ...
  return (
    <div className="relative h-screen w-full">
      ...
      <div className="absolute bottom-16 left-0 right-0 px-4 pb-4 flex justify-between gap-8">
        <Sheet>
          <SheetTrigger asChild>
            <Card className="cursor-pointer rounded-t-2xl rounded-b-lg bg-card shadow-lg py-0 flex-1">
        ...
        <FabActions className="relative bottom-0 right-0" />
      </div>
    </div>
  );
}
