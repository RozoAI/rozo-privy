...
export const InsufficientBalanceDialog = memo(
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-3 text-left">
              <p>
                You need at least <strong>{requiredBalance} XLM</strong> to
                enable USDC trustline, but your current balance is{" "}
              ...
              <div className="bg-amber-50 dark:bg-amber-950 p-3 rounded-md border border-amber-200 dark:border-amber-800">
                ...
                <ul className="text-sm text-amber-700 dark:text-amber-300 space-y-1">
                  <li>
                    • <strong>1.0 XLM</strong> - Stellar minimum account balance
                    requirement
                  </li>
                  <li>
